...
import { loginDoctor, setCurrentSession } from '../services/authService';
...
export default function DoctorLogin() {
  ...
  const handlePasswordLogin = async (e) => {
    ...
    try {
      const result = loginDoctor(phone, password);
  ...
  const handleOTPLogin = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Find doctor by phone and create session
        ...
        if (doctor) {
          ...
          setError('Doctor not found. Please sign up first.');
        }
      } else {
