...
import { User, Stethoscope, Heart, Pill } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const features = [
    { icon: <Brain className="h-6 w-6 text-white" />, title: 'AI Symptom Checker', description: 'Advanced AI analyzes symptoms and provides preliminary health assessments with high accuracy.', color: 'bg-gradient-to-br from-purple-500 to-purple-600' },
    { icon: <Video className="h-6 w-6 text-white" />, title: 'Video Consultations', description: 'Secure, high-quality video calls with certified doctors from the comfort of your home.', color: 'bg-gradient-to-br from-blue-500 to-blue-600' },
    { icon: <FileText className="h-6 w-6 text-white" />, title: 'Digital Health Records', description: 'Centralized, encrypted health records accessible to you and your healthcare providers.', color: 'bg-gradient-to-br from-teal-500 to-teal-600' },
    { icon: <Truck className="h-6 w-6 text-white" />, title: 'Medicine Delivery', description: 'Fast, reliable delivery of prescribed medications directly to your doorstep.', color: 'bg-gradient-to-br from-green-500 to-green-600' },
    { icon: <UsersIcon className="h-6 w-6 text-white" />, title: 'Community Health', description: 'Connect with local ASHA workers and participate in community health programs.', color: 'bg-gradient-to-br from-orange-500 to-orange-600' },
    { icon: <MessageSquare className="h-6 w-6 text-white" />, title: '24/7 Support', description: 'Round-the-clock customer support and emergency assistance when you need it most.', color: 'bg-gradient-to-br from-red-500 to-red-600' }
  ];

  // Roles
  const roles = [
    { role: 'user', title: 'Patient', description: 'Book consultations, access health records, and get AI-powered symptom analysis.', icon: <User className="h-8 w-8 text-white" />, gradient: 'bg-gradient-to-br from-blue-500 to-blue-600' },
    { role: 'doctor', title: 'Doctor', description: 'Conduct video consultations, manage patient records, and provide expert care.', icon: <Stethoscope className="h-8 w-8 text-white" />, gradient: 'bg-gradient-to-br from-teal-500 to-teal-600' },
    { role: 'asha', title: 'ASHA Worker', description: 'Support community health initiatives and coordinate patient care.', icon: <Heart className="h-8 w-8 text-white" />, gradient: 'bg-gradient-to-br from-green-500 to-green-600' },
    { role: 'pharmacy', title: 'Pharmacy', description: 'Manage prescriptions, provide medicine delivery, and track inventory.', icon: <Pill className="h-8 w-8 text-white" />, gradient: 'bg-gradient-to-br from-purple-500 to-purple-600' }
  ];
